...
public interface ILicensingService extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements com.android.vending.licensing.ILicensingService {
		 ...
		 */
		public static com.android.vending.licensing.ILicensingService asInterface(final android.os.IBinder obj) {
			if (obj == null) {
				return null;
			}
		...
		private static class Proxy implements com.android.vending.licensing.ILicensingService {
			...
			public void checkLicense(final long nonce, final java.lang.String packageName, final com.android.vending.licensing.ILicenseResultListener listener) throws android.os.RemoteException {
