	...
	public void onReceive(final Context context, final Intent intent) {
		if (intent.hasExtra(SmartPhonePluginHelper.SMART_PHONE_PLUGIN_DATA)) {
			final String data = intent
					.getStringExtra(SmartPhonePluginHelper.SMART_PHONE_PLUGIN_DATA);

			final boolean toggleBack = intent.getBooleanExtra(
					SmartPhonePluginHelper.SMART_PHONE_PLUGIN_TOGGLE_BACK,
					false);
