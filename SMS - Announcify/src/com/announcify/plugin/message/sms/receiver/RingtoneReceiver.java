...
public class RingtoneReceiver extends BroadcastReceiver {
    public static final String ACTION_START_RINGTONE = "com.announcify.plugin.message.sms.ACTION_START_RINGTONE";

    public static final String ACTION_STOP_RINGTONE = "com.announcify.plugin.message.sms.ACTION_STOP_RINGTONE";
