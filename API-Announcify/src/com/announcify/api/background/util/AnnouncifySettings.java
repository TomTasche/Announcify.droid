...
public class AnnouncifySettings {
	...
	public static final String KEY_ERROR_REPORTING = "preference_automatic_error_reporting";
	...
	public String getDefaultDefaultMode() {
		return preferences.getString(PluginSettings.KEY_READING_ANNOUNCEMENT,
				"<NAME>");
	}

	public String getDefaultDiscreetMode() {
		return preferences.getString(PluginSettings.KEY_READING_DISCREET,
				"<NAME>");
	}

	public int getDefaultReadingBreak() {
		return Integer.parseInt(preferences.getString(
				PluginSettings.KEY_READING_BREAK, "2"));
	}

	public int getDefaultReadingRepeat() {
		return Integer.parseInt(preferences.getString(
				PluginSettings.KEY_READING_REPEAT, "1"));
	}

	public int getDefaultReadingWait() {
		return Integer.parseInt(preferences.getString(
				PluginSettings.KEY_READING_WAIT, "0"));
	}

	public String getDefaultUnknownMode() {
		return preferences.getString(PluginSettings.KEY_READING_UNKNOWN,
				"<UNKNOWN>");
	}
	...
	public boolean isAutomaticErrorReporting() {
		return preferences.getBoolean(KEY_ERROR_REPORTING, true);
	}
