...
class ResponseData {
	...
	public static ResponseData parse(final String responseData) {
		...
		final String[] fields = TextUtils.split(mainData, Pattern.quote("|"));
		if (fields.length < 6) {
