...
public class FormatActivity extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_name).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_firstname).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_lastname).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_nickname).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_fullname).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_title).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_address).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_address_type).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_event).setOnClickListener(
                new OnClickListener() {
        ...
        findViewById(R.id.button_message).setOnClickListener(
                new OnClickListener() {
